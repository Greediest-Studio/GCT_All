...
import com.gmm.gctall.world.biome.BiomeVoidPlain;
...
public class WorldDIM100
{
    ...
    public static void registerDimension() {
        ...
        WorldDIM100.dtype = DimensionType.register("the_void", "_the_void", WorldDIM100.DIMID, WorldProviderMod.class, true);
        ...
        public void onEntityCollision(final World worldIn, final BlockPos pos, final IBlockState state, final Entity entityIn) {
            if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
                ...
                if (thePlayer.timeUntilPortal > 0) {
                    ...
                    thePlayer.timeUntilPortal = 10;
          PlayerDimensionTransferHelper.transfer(thePlayer, WorldDIM100.DIMID, this.getTeleporterForDimension((Entity)thePlayer, pos, WorldDIM100.DIMID));
                }
                else {
                    thePlayer.timeUntilPortal = 10;
