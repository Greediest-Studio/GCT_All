...
@Tag
public class BiomeAquariusIceplain extends GctAllElement {
  @ObjectHolder("gct_all:aquarius_iceplain")
  public static final BiomeGenCustom biome = null;
  
  public BiomeAquariusIceplain(GctAllContent instance) {
    super(instance, 343);
  }
  ...
  public void init(FMLInitializationEvent event) {
    BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.COLD });
  }
