...
@Tag
public class BiomeAlfheimForest extends GctAllElement {
  @ObjectHolder("gct_all:alfheim_forest")
  public static final BiomeGenCustom biome = null;
  
  public BiomeAlfheimForest(GctAllContent instance) {
    super(instance, 285);
  }
  ...
  static class BiomeGenCustom extends Biome {
    public BiomeGenCustom() {
      super((new Biome.BiomeProperties("Alfheim Forest")).setRainfall(0.5F).setBaseHeight(0.1F).setHeightVariation(0.3F).setTemperature(0.5F));
    ...
    public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
      return new BiomeAlfheimForest.CustomTree();
    }
  }
