...
import com.gmm.gctall.block.BlockReversedAlfDirt;
import com.gmm.gctall.block.BlockReversedAlfGrass;
import com.gmm.gctall.block.BlockReversedDreamwoodLeaves;
import com.gmm.gctall.block.BlockReversedDreamwoodLog;
...
@Tag
public class BiomeReversedForest extends GctAllElement {
  @ObjectHolder("gct_all:reversed_forest")
  public static final BiomeGenCustom biome = null;
  
  public BiomeReversedForest(GctAllContent instance) {
    super(instance, 286);
  }
  ...
  public void init(FMLInitializationEvent event) {
    BiomeDictionary.addTypes(biome, new BiomeDictionary.Type[] { BiomeDictionary.Type.FOREST, BiomeDictionary.Type.MUSHROOM, BiomeDictionary.Type.MAGICAL });
  }
