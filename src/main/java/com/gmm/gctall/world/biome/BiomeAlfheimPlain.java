...
@Tag
public class BiomeAlfheimPlain extends GctAllElement {
  @ObjectHolder("gct_all:alfheim_plain")
  public static final BiomeGenCustom biome = null;
  
  public BiomeAlfheimPlain(GctAllContent instance) {
    super(instance, 237);
  }
  ...
  static class BiomeGenCustom extends Biome {
    public BiomeGenCustom() {
      super((new Biome.BiomeProperties("Alfheim Plain")).setRainfall(0.5F).setBaseHeight(0.1F).setHeightVariation(0.2F).setTemperature(0.5F));
    ...
    public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
      return new BiomeAlfheimPlain.CustomTree();
    }
  }
