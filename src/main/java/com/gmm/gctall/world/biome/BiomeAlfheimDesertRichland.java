...
@Tag
public class BiomeAlfheimDesertRichland extends GctAllElement {
  @ObjectHolder("gct_all:alfheim_desert_richland")
  public static final BiomeGenCustom biome = null;
  
  public BiomeAlfheimDesertRichland(GctAllContent instance) {
    super(instance, 242);
  }
  ...
  static class BiomeGenCustom extends Biome {
    public BiomeGenCustom() {
      super((new Biome.BiomeProperties("Alfheim Desert Richland")).setRainfall(0.0F).setBaseHeight(1.0F).setWaterColor(-256).setHeightVariation(0.1F)
          .setTemperature(2.0F));
    ...
    public WorldGenAbstractTree getRandomTreeFeature(Random rand) {
      return new BiomeAlfheimDesertRichland.CustomTree();
    }
  }
