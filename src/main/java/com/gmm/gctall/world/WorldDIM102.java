...
import com.gmm.gctall.world.biome.BiomeOrderBasin;
import com.gmm.gctall.world.biome.BiomeOrderPlain;
import com.gmm.gctall.world.biome.BiomeOrderPlateu;
...
public class WorldDIM102
{
    ...
    public static void registerDimension() {
        ...
        WorldDIM102.dtype = DimensionType.register("orderland", "_orderland", WorldDIM102.DIMID, WorldProviderMod.class, true);
        ...
        public void onEntityCollision(final World worldIn, final BlockPos pos, final IBlockState state, final Entity entityIn) {
            if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
                ...
                if (thePlayer.timeUntilPortal > 0) {
                    ...
                    thePlayer.timeUntilPortal = 10;
          PlayerDimensionTransferHelper.transfer(thePlayer, WorldDIM102.DIMID, this.getTeleporterForDimension((Entity)thePlayer, pos, WorldDIM102.DIMID));
                }
                else {
                    thePlayer.timeUntilPortal = 10;
