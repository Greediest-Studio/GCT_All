...
@Tag
public class WorldWarpedRuin extends GctAllElement {
  public static int DIMID = 55;
  
  public static final boolean NETHER_TYPE = false;
  
  @ObjectHolder("gct_all:warped_ruin_portal")
  public static final BlockCustomPortal portal = null;
  
  public static DimensionType dtype;
  
  public WorldWarpedRuin(GctAllContent instance) {
    super(instance, 39);
  }
  ...
  public void initElements() {
    ...
    registerItem(() -> (Item)(new ItemWarpedRuin()).setTranslationKey("warped_ruin").setRegistryName("warped_ruin"),
        "warped_ruin");
  }
    ...
    public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
      if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
        ...
        if (thePlayer.timeUntilPortal > 0) {
          ...
          thePlayer.server.getPlayerList().transferPlayerToDimension(thePlayer, WorldWarpedRuin.DIMID, getTeleporterForDimension((Entity)thePlayer, pos, WorldWarpedRuin.DIMID));
        } else {
          thePlayer.timeUntilPortal = 10;
          ReflectionHelper.setPrivateValue(EntityPlayerMP.class, thePlayer, Boolean.valueOf(true), "invulnerableDimensionChange", "invulnerableDimensionChange");
  ...
  public static class GenLayerBiomesCustom extends GenLayer {
    private Biome[] allowedBiomes = new Biome[] { (Biome)Biome.REGISTRY.getObject(new ResourceLocation("gct_all:warped")) };
