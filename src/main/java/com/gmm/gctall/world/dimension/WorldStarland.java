...
import com.gmm.gctall.block.BlockPolarisite;
...
@Tag
public class WorldStarland extends GctAllElement {
  ...
  public WorldStarland(GctAllContent instance) {
    super(instance, 336);
  }
  ...
  public static class GenLayerBiomesCustom extends GenLayer {
    private Biome[] allowedBiomes = new Biome[] { 
        (Biome)Biome.REGISTRY.getObject(new ResourceLocation("gct_all:aries_forest")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:taurus_plataeu")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:gemini_valley")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:cancer_hills")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:leo_badlands")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:virgo_plain")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:capricorns_cliffs")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:aquarius_iceplain")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:sagittarius_denseforest")), 
        (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:scorpio_desert")), (Biome)Biome.REGISTRY
        .getObject(new ResourceLocation("gct_all:libra_island")) };
