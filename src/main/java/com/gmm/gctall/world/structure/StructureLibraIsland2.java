...
@Tag
public class StructureLibraIsland2 extends GctAllElement {
  public StructureLibraIsland2(GctAllContent instance) {
    super(instance, 349);
  }
    ...
    if (random.nextInt(1000000) + 1 <= 100000) {
      ...
      for (int a = 0; a < count; a++) {
        ...
        if ((new ResourceLocation("gct_all:libra_island")).equals(Biome.REGISTRY.getNameForObject(biome)))
          StructureGenerationHelper.placeTemplate(world, random, new ResourceLocation("gct_all", "astral_island_2"), new BlockPos(i, j, k)); 
      } 
    } 
  }
}
