...
public final class PotionChanneling {
  public static final Potion potion = new ChannelingEffect();

  public static final PotionType potionType = new ChannelingEffectType();
  private PotionChanneling() {
  }

  public static class ChannelingEffectType extends PotionType {
    public ChannelingEffectType() {
  ...
  public static class ChannelingEffect extends Potion {
    private final ResourceLocation potionIcon;

    public ChannelingEffect() {
      super(true, -13434625);
      setRegistryName(new ResourceLocation(Tags.MOD_ID, "channeling"));
