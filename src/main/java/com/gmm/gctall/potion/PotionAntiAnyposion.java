...
public final class PotionAntiAnyposion {
  public static final Potion potion = new AntiAnyposionEffect();

  public static final PotionType potionType = new AntiAnyposionEffectType();
  private PotionAntiAnyposion() {
  }

  public static class AntiAnyposionEffectType extends PotionType {
    public AntiAnyposionEffectType() {
  ...
  public static class AntiAnyposionEffect extends Potion {
    private final ResourceLocation potionIcon;

    public AntiAnyposionEffect() {
      super(false, -1);
      setRegistryName(new ResourceLocation(Tags.MOD_ID, "anti_anyposion"));
