...
public final class PotionStop {
  public static final Potion potion = new StopEffect();

  public static final PotionType potionType = new StopEffectType();
  private PotionStop() {
  }

  public static class StopEffectType extends PotionType {
    public StopEffectType() {
      super(new PotionEffect[] { new PotionEffect(PotionStop.potion, 3600) });
      setRegistryName(new ResourceLocation(Tags.MOD_ID, "stop"));
    }
  }

  public static class StopEffect extends Potion {
