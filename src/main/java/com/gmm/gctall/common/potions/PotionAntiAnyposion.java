...
public class PotionAntiAnyposion extends Potion {
    public static final PotionAntiAnyposion potion = new PotionAntiAnyposion();
    ...
    private final ResourceLocation icon = new ResourceLocation(Tags.MOD_ID, "textures/mob_effect/anti_anyposion.png");
