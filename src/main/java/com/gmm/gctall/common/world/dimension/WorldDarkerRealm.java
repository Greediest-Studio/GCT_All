...
public class WorldDarkerRealm {
  ...
  public static class WorldProviderMod extends WorldProvider {
    public void init() {
      this.biomeProvider = new WorldDarkerRealm.BiomeProviderCustom(this.world.getSeed());
      this.nether = true;
    }
    ...
    public IChunkGenerator createChunkGenerator() {
      return new WorldDarkerRealm.ChunkProviderModded(this.world, this.world.getSeed() - WorldDarkerRealm.DIMID);
    }
  ...
  public static class TeleporterDimensionMod extends Teleporter {
    ...
    public boolean makePortal(Entity entityIn) {
      ...
      IBlockState iblockstate = WorldDarkerRealm.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (l6 == 0) ? (Comparable)EnumFacing.Axis.Z : (Comparable)EnumFacing.Axis.X);
    ...
    public boolean placeInExistingPortal(Entity entityIn, float rotationYaw) {
        ...
        for (int i1 = -128; i1 <= 128; i1++) {
          for (int j1 = -128; j1 <= 128; j1++) {
            ...
            while (blockpos1.getY() >= 0) {
              ...
              if (this.world.getBlockState(blockpos1).getBlock() == WorldDarkerRealm.portal) {
                for (blockpos2 = blockpos1.down(); this.world.getBlockState(blockpos2).getBlock() == WorldDarkerRealm.portal;
      ...
      if (d0 >= 0.0D) {
        ...
        BlockPattern.PatternHelper blockpattern$patternhelper = WorldDarkerRealm.portal.createPatternHelper((World)this.world, blockpos);
  ...
  public static class PortalBlock extends BlockPortal {
    ...
    public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
      if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
        ...
        } else if (thePlayer.dimension != WorldDarkerRealm.DIMID) {
          thePlayer.timeUntilPortal = 10;
          PlayerDimensionTransferHelper.transfer(thePlayer, WorldDarkerRealm.DIMID, getTeleporterForDimension((Entity)thePlayer, pos, WorldDarkerRealm.DIMID));
        } else {
          thePlayer.timeUntilPortal = 10;
    ...
    private WorldDarkerRealm.TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, int dimid) {
      BlockPattern.PatternHelper bph = WorldDarkerRealm.portal.createPatternHelper(entity.world, new BlockPos((Vec3i)pos));
      ...
      return new WorldDarkerRealm.TeleporterDimensionMod(entity.getServer().getWorld(dimid), new Vec3d(d1, d2, 0.0D), bph.getForwards());
    }
    ...
    public static class Size {
        ...
        label38: for (this.height = 0; this.height < 21; this.height++) {
          for (int i = 0; i < this.width; i++) {
            ...
            if (!isEmptyBlock(block))
              break label38;
            if (block == WorldDarkerRealm.portal)
      ...
      protected boolean isEmptyBlock(Block blockIn) {
        return (blockIn.getDefaultState().getMaterial() == Material.AIR || blockIn == Blocks.FIRE || blockIn == WorldDarkerRealm.portal);
      }
      ...
      public void placePortalBlocks() {
        for (int i = 0; i < this.width; i++) {
          ...
          for (int j = 0; j < this.height; j++)
            this.world.setBlockState(blockpos.up(j), WorldDarkerRealm.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (Comparable)this.axis), 2);
        }
      }
    }
  }
  ...
  public static class ChunkProviderModded implements IChunkGenerator {
    ...
    public void prepareHeights(int p_185936_1_, int p_185936_2_, ChunkPrimer primer) {
      ...
      int l = 17;
      int i1 = 5;
      this.buffer = getHeights(this.buffer, p_185936_1_ * 4, 0, p_185936_2_ * 4, 5, 17, 5);
    ...
    public void buildSurfaces(int p_185937_1_, int p_185937_2_, ChunkPrimer primer) {
      ...
      this.stoneNoise3 = this.secondaryStoneNoiseGen.generateNoiseOctaves(this.stoneNoise3, p_185937_1_ * 16, 109, p_185937_2_ * 16, 16, 1, 16, 0.03125D, 1.0D, 0.03125D);
      this.depthBuffer = this.depthNoiseGen.generateNoiseOctaves(this.depthBuffer, p_185937_1_ * 16, p_185937_2_ * 16, 0, 16, 16, 1, 0.0625D, 0.0625D, 0.0625D);
      for (int j = 0; j < 16; j++) {
        for (int k = 0; k < 16; k++) {
  ...
  public static class BiomeProviderCustom extends BiomeProvider {
    ...
    private GenLayer[] makeTheWorld(long seed) {
      GenLayer biomes = new WorldDarkerRealm.GenLayerBiomesCustom(1L);
