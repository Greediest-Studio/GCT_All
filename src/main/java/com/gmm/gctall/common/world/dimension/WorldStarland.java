...
import com.gmm.gctall.common.world.biome.BiomeAquariusIceplain;
import com.gmm.gctall.common.world.biome.BiomeAriesForest;
import com.gmm.gctall.common.world.biome.BiomeCancerHills;
import com.gmm.gctall.common.world.biome.BiomeCapricornsCliffs;
import com.gmm.gctall.common.world.biome.BiomeGeminiValley;
import com.gmm.gctall.common.world.biome.BiomeLeoBadlands;
import com.gmm.gctall.common.world.biome.BiomeLibraIsland;
import com.gmm.gctall.common.world.biome.BiomeSagittariusDenseforest;
import com.gmm.gctall.common.world.biome.BiomeScorpioDesert;
import com.gmm.gctall.common.world.biome.BiomeTaurusPlataeu;
import com.gmm.gctall.common.world.biome.BiomeVirgoPlain;
...
public class WorldStarland {
  public static int DIMID = 80;
...
public static void registerDimension() {
    if (DimensionManager.isDimensionRegistered(DIMID)) {
      ...
      System.err.println("Dimension ID for dimension starland is already registered. Falling back to ID: " + DIMID);
    }
    dtype = DimensionType.register("starland", "_starland", DIMID, WorldProviderMod.class, false);
    DimensionManager.registerDimension(DIMID, dtype);
  }

  public static class WorldProviderMod extends WorldProvider {
    public void init() {
      this.biomeProvider = new WorldStarland.BiomeProviderCustom(this.world.getSeed());
      this.nether = false;
      this.hasSkyLight = true;
    }

    public DimensionType getDimensionType() {
      return WorldStarland.dtype;
    }
    ...
    public IChunkGenerator createChunkGenerator() {
      return new WorldStarland.ChunkProviderModded(this.world, this.world.getSeed() - WorldStarland.DIMID);
    }
  ...
  public static class ChunkProviderModded implements IChunkGenerator {
    private static final IBlockState STONE = BlockPolarisite.block.getDefaultState();

    private static final IBlockState STONE2 = BlockPolarisite.block.getDefaultState();
    ...
    public ChunkProviderModded(World worldIn, long seed) {
      ...
      this.caveGenerator = (MapGenBase)new MapGenCaves() {
          protected boolean canReplaceBlock(IBlockState a, IBlockState b) {
            if (a.getBlock() == WorldStarland.ChunkProviderModded.STONE.getBlock())
              return true;
      ...
      this.ravineGenerator = (MapGenBase)new MapGenRavine() {
          protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
            ...
            if (state.getBlock() == WorldStarland.ChunkProviderModded.STONE.getBlock() || state.getBlock() == biome.topBlock.getBlock() || state
  ...
  public static class GenLayerBiomesCustom extends GenLayer {
    private Biome[] allowedBiomes = new Biome[] { BiomeAriesForest.biome, BiomeTaurusPlataeu.biome,
        BiomeGeminiValley.biome, BiomeCancerHills.biome, BiomeLeoBadlands.biome, BiomeVirgoPlain.biome,
        BiomeCapricornsCliffs.biome, BiomeAquariusIceplain.biome, BiomeSagittariusDenseforest.biome,
        BiomeScorpioDesert.biome, BiomeLibraIsland.biome };
  ...
  public static class BiomeProviderCustom extends BiomeProvider {
    ...
    private GenLayer[] makeTheWorld(long seed) {
      GenLayer biomes = new WorldStarland.GenLayerBiomesCustom(1L);
