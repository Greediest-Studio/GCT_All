...
import com.gmm.gctall.common.world.biome.BiomeNowhere;
...
public class WorldTheNowhere {
    ...
    public static void registerDimension() {
        if (DimensionManager.isDimensionRegistered(WorldTheNowhere.DIMID)) {
  ...
  public static class WorldProviderMod extends WorldProvider
    {
        ...
        public IChunkGenerator createChunkGenerator() {
            return (IChunkGenerator)new ChunkProviderModded(this.world, this.world.getSeed() - WorldTheNowhere.DIMID);
        }
  ...
  public static class TeleporterDimensionMod extends Teleporter
    {
        ...
        public boolean makePortal(final Entity entityIn) {
            ...
            final IBlockState iblockstate = WorldTheNowhere.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (Comparable)((l7 == 0) ? EnumFacing.Axis.Z : EnumFacing.Axis.X));
        ...
        public boolean placeInExistingPortal(final Entity entityIn, final float rotationYaw) {
                ...
                for (int i2 = -128; i2 <= 128; ++i2) {
                    for (int j2 = -128; j2 <= 128; ++j2) {
                        ...
                        for (BlockPos blockpos3 = blockpos2.add(i2, this.world.getActualHeight() - 1 - blockpos2.getY(), j2); blockpos3.getY() >= 0; blockpos3 = blockpos4) {
                            ...
                            if (this.world.getBlockState(blockpos3).getBlock() == WorldTheNowhere.portal) {
                                for (blockpos4 = blockpos3.down(); this.world.getBlockState(blockpos4).getBlock() == WorldTheNowhere.portal; blockpos4 = blockpos4.down()) {
                                    blockpos3 = blockpos4;
                                }
            ...
            if (d0 >= 0.0) {
                ...
                final BlockPattern.PatternHelper blockpattern$patternhelper = WorldTheNowhere.portal.createPatternHelper((World)this.world, blockpos);
  ...
  public static class PortalBlock extends BlockPortal
    {
        ...
        public void onEntityCollision(final World worldIn, final BlockPos pos, final IBlockState state, final Entity entityIn) {
            if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
                ...
                else if (thePlayer.dimension != WorldTheNowhere.DIMID) {
                    thePlayer.timeUntilPortal = 10;
          PlayerDimensionTransferHelper.transfer(thePlayer, WorldTheNowhere.DIMID, this.getTeleporterForDimension((Entity)thePlayer, pos, WorldTheNowhere.DIMID));
                }
                else {
                    thePlayer.timeUntilPortal = 10;
        ...
        private TeleporterDimensionMod getTeleporterForDimension(final Entity entity, final BlockPos pos, final int dimid) {
            final BlockPattern.PatternHelper bph = WorldTheNowhere.portal.createPatternHelper(entity.world, new BlockPos((Vec3i)pos));
        ...
        public static class Size
        {
            ...
            Label_0197:
                while (this.height < 21) {
                    for (int i = 0; i < this.width; ++i) {
                        ...
                        if (block == WorldTheNowhere.portal) {
            ...
            protected boolean isEmptyBlock(final Block blockIn) {
                return blockIn.getDefaultState().getMaterial() == Material.AIR || blockIn == Blocks.FIRE || blockIn == WorldTheNowhere.portal;
            }
            ...
            public void placePortalBlocks() {
                for (int i = 0; i < this.width; ++i) {
                    ...
                    for (int j = 0; j < this.height; ++j) {
                        this.world.setBlockState(blockpos.up(j), WorldTheNowhere.portal.getDefaultState().withProperty((IProperty)BlockPortal.AXIS, (Comparable)this.axis), 2);
                    }
                }
            }
        }
