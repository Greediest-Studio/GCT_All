...
import com.gmm.gctall.common.world.biome.BiomeBloodyplain;
import com.gmm.gctall.common.world.biome.BiomeCurruptplain;
    ...
    public ChunkProviderModded(World worldIn, long seed) {
      ...
      this.ravineGenerator = (MapGenBase)new MapGenRavine() {
          protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop) {
            ...
            if (state.getBlock() == WorldBesideVoid.ChunkProviderModded.STONE.getBlock() || state.getBlock() == biome.topBlock.getBlock() || state
