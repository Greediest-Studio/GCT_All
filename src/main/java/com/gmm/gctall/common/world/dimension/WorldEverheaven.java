...
import com.gmm.gctall.common.world.biome.BiomeEverheavenWaste;
...
public static class WorldProviderMod extends WorldProvider {
  ...
  public static class PortalBlock extends BlockPortal {
    ...
    public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
      if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
        ...
        } else if (thePlayer.dimension != WorldEverheaven.DIMID) {
          thePlayer.timeUntilPortal = thePlayer.getPortalCooldown();
          thePlayer.changeDimension(WorldEverheaven.DIMID, getTeleporterForDimension((Entity)thePlayer, pos, WorldEverheaven.DIMID));
        } else {
          thePlayer.timeUntilPortal = thePlayer.getPortalCooldown();
  ...
  public static class ChunkProviderModded implements IChunkGenerator {
    ...
    private double[] getHeights(double[] p_185963_1_, int p_185963_2_, int p_185963_3_, int p_185963_4_, int p_185963_5_, int p_185963_6_, int p_185963_7_) {
      ...
      double d1 = 684.412D;
      d0 *= 2.0D;
      this.pnr = this.perlinnoise3.generateNoiseOctaves(this.pnr, p_185963_2_, p_185963_3_, p_185963_4_, p_185963_5_, p_185963_6_, p_185963_7_, d0 / 80.0D, 4.277575000000001D, d0 / 80.0D);
      this.ar = this.perlinnoise1.generateNoiseOctaves(this.ar, p_185963_2_, p_185963_3_, p_185963_4_, p_185963_5_, p_185963_6_, p_185963_7_, d0, 684.412D, d0);
      this.br = this.perlinnoise2.generateNoiseOctaves(this.br, p_185963_2_, p_185963_3_, p_185963_4_, p_185963_5_, p_185963_6_, p_185963_7_, d0, 684.412D, d0);
      int i = p_185963_2_ / 2;
      int j = p_185963_4_ / 2;
      int k = 0;
