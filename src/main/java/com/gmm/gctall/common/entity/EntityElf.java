...
import com.gmm.gctall.common.events.ElfTrade;
...
public final class EntityElf {
  ...
  public static class ElfEntity extends EntityMob {
    ...
    protected void initEntityAI() {
      ...
      this.targetTasks.addTask(3, (EntityAIBase)new EntityAIHurtByTarget((EntityCreature)this, false, new Class[0]));
    ...
    public boolean processInteract(EntityPlayer entity, EnumHand hand) {
      ...
      ElfTrade.run(entity, this.world, x, y, z);
      return true;
    }
