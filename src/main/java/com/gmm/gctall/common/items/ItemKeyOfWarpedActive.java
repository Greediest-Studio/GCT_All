...
import com.gmm.gctall.common.events.KeyOfWarpedRightClickedOnBlock;
...
public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
    ...
    private EnumActionResult useKey(EntityPlayer entity, World world, BlockPos pos, EnumHand hand,
      ...
      int y = pos.getY();
      int z = pos.getZ();
      return KeyOfWarpedRightClickedOnBlock.run(entity, world, x, y, z) ? EnumActionResult.SUCCESS : EnumActionResult.FAIL;
    }
  }
