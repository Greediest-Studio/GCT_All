...
public class ItemMuddyFlesh extends ItemFood {
  public static final Item block = new ItemMuddyFlesh();
    private static final float SANITY_CHANGE = 0.0F;

    public ItemMuddyFlesh() {
      super(3, 0.3F, false);
