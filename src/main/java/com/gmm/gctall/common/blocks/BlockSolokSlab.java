...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockSolokSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockSolokSlab();
  public static final Block block_slab_double = new Double();

  public BlockSolokSlab() {
    super(Material.WOOD);
  ...
  public static class Double extends BlockSolokSlab {
    public Double() {
      super();
    }
