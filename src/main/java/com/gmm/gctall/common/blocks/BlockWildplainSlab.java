...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockWildplainSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockWildplainSlab();
  public static final Block block_slab_double = new Double();

  public BlockWildplainSlab() {
    super(Material.WOOD);
  ...
  public static class Double extends BlockWildplainSlab {
    public Double() {
      super();
    }
