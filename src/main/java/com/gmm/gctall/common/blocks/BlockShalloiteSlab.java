...
public class BlockShalloiteSlab extends BlockSlab {
    public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
    public static final Block block = new BlockShalloiteSlab();
    public static final Block block_slab_double = new Double();

    public BlockShalloiteSlab() {
    super(Material.ROCK);
    ...
    public static class Double extends BlockShalloiteSlab
    {
    public Double() {
    super();
    }
