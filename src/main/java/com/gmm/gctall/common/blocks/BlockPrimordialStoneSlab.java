...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockPrimordialStoneSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockPrimordialStoneSlab();
  public static final Block block_slab_double = new Double();

  public BlockPrimordialStoneSlab() {
    super(Material.ROCK);
  ...
  public static class Double extends BlockPrimordialStoneSlab {
    public Double() {
      super();
    }
