...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockWarprackSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockWarprackSlab();
  public static final Block block_slab_double = new Double();

  public BlockWarprackSlab() {
    super(Material.ROCK);
  ...
  public static class Double extends BlockWarprackSlab {
    public Double() {
      super();
    }
