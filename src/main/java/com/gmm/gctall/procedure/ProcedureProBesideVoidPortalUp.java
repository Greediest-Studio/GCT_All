...
@Tag
public class ProcedureProBesideVoidPortalUp extends GctAllElement {
  public ProcedureProBesideVoidPortalUp(GctAllContent instance) {
    super(instance, 152);
  }
  
  public static void executeProcedure(Map<String, Object> dependencies) {
    if (!ProcedureContext.require(dependencies, "ProBesideVoidPortalUp", "x", "y", "z", "world"))
      return;
