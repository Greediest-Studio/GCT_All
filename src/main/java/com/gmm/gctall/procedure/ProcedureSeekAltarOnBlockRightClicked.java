...
public final class ProcedureSeekAltarOnBlockRightClicked {
  private ProcedureSeekAltarOnBlockRightClicked() {
  }
    ...
    if ((new Object() {
      ...
      if (world.getBlockState(new BlockPos(x, y + 1, z)).getBlock() == BlockAzathothiumOreComplex.block.getDefaultState()
        ...
        if (!world.isRemote) {
          ...
          if (_tileEntity != null)
            _tileEntity.getTileData().setString("recipeName", "azathothium");
        ...
        if (!world.isRemote) {
          ...
          IBlockState _bs = world.getBlockState(_bp);
          if (_tileEntity != null)
            _tileEntity.getTileData().setString("recipeName", "nyarlathotepium");
          world.notifyBlockUpdate(_bp, _bs, _bs, 3);
        }
        ...
        if (!world.isRemote) {
          ...
          IBlockState _bs = world.getBlockState(_bp);
          if (_tileEntity != null)
            _tileEntity.getTileData().setString("recipeName", "yogsothothium");
          world.notifyBlockUpdate(_bp, _bs, _bs, 3);
        }
        ...
        if (!world.isRemote) {
          ...
          IBlockState _bs = world.getBlockState(_bp);
          if (_tileEntity != null)
            _tileEntity.getTileData().setString("recipeName", "shubniggurathium");
          world.notifyBlockUpdate(_bp, _bs, _bs, 3);
        }
