...
@Tag
public class ProcedureAbyssPlaguePlayerCollidesWithThisEntity extends GctAllElement {
  public ProcedureAbyssPlaguePlayerCollidesWithThisEntity(GctAllContent instance) {
    super(instance, 10);
  }
