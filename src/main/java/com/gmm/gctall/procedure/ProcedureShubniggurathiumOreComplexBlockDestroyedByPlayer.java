...
@Tag
public class ProcedureShubniggurathiumOreComplexBlockDestroyedByPlayer extends GctAllElement {
  public ProcedureShubniggurathiumOreComplexBlockDestroyedByPlayer(GctAllContent instance) {
    super(instance, 46);
  }
