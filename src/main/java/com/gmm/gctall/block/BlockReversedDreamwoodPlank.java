...
@Tag
public class BlockReversedDreamwoodPlank extends GctAllElement {
  @ObjectHolder("gct_all:reversed_dreamwood_plank")
  public static final Block block = null;
  
  public BlockReversedDreamwoodPlank(GctAllContent instance) {
    super(instance, 277);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("reversed_dreamwood_plank"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "reversed_dreamwood_plank");
  }
  ...
  public static class BlockCustom extends Block {
    ...
    public BlockCustom() {
      super(Material.ROCK);
      setTranslationKey("reversed_dreamwood_plank");
