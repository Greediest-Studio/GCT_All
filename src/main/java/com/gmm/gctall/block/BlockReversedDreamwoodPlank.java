...
import net.minecraft.world.World;
  ...
  public class BlockReversedDreamwoodPlank extends Block {
  public static final PropertyDirection FACING = BlockDirectional.FACING;
  public static final Block block = new BlockReversedDreamwoodPlank();

  public BlockReversedDreamwoodPlank() {
    super(Material.ROCK);
