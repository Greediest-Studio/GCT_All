...
import com.gmm.gctall.procedure.ProcedureAzathothiumOreComplexBlockDestroyedByPlayer;
...
@Tag
public class BlockAzathothiumOreComplex extends GctAllElement {
  @ObjectHolder("gct_all:azathothium_ore_complex")
  public static final Block block = null;
  
  public BlockAzathothiumOreComplex(GctAllContent instance) {
    super(instance, 37);
  }
  
  public void initElements() {
    registerBlockWithItem(BlockCustom::new, "azathothium_ore_complex");
  }
  ...
  public static class BlockCustom extends Block {
    ...
    public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
      ...
      ProcedureAzathothiumOreComplexBlockDestroyedByPlayer.executeProcedure($_dependencies);
      return retval;
    }
  }
}
