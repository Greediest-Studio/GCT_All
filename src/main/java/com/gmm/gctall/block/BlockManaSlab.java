...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockManaSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockManaSlab();
  public static final Block block_slab_double = new Double();

  public BlockManaSlab() {
    super(Material.WOOD);
  ...
  public static class Double extends BlockManaSlab {
    public Double() {
      super();
    }
