...
@Tag
public class BlockManaSlab extends GctAllElement {
  @ObjectHolder("gct_all:mana_slab")
  public static final Block block = null;
  
  @ObjectHolder("gct_all:mana_slab_double")
  public static final Block block_slab_double = null;
  
  public BlockManaSlab(GctAllContent instance) {
    super(instance, 393);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("mana_slab"));
    this.elements.blocks.add(() -> (Block)(new BlockCustom.Double()).setRegistryName("mana_slab_double"));
  ...
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "mana_slab");
  }
  
  public static class BlockCustom extends BlockSlab {
    public BlockCustom() {
      super(Material.WOOD);
      setTranslationKey("mana_slab");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
      return Item.getItemFromBlock(BlockManaSlab.block);
    }
    
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
      return new ItemStack(BlockManaSlab.block);
    }
