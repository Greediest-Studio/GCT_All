...
@Tag
public class BlockManaStrawSmall extends GctAllElement {
  @ObjectHolder("gct_all:mana_straw_small")
  public static final Block block = null;
  
  public BlockManaStrawSmall(GctAllContent instance) {
    super(instance, 388);
  }
  ...
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "mana_straw_small");
  }
