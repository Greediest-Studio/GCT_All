...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockEvileyeSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockEvileyeSlab();
  public static final Block block_slab_double = new Double();

  public BlockEvileyeSlab() {
    super(Material.WOOD);
  ...
  public static class Double extends BlockEvileyeSlab {
    public Double() {
      super();
    }
