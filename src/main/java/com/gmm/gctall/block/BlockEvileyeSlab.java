...
@Tag
public class BlockEvileyeSlab extends GctAllElement {
  @ObjectHolder("gct_all:evileye_slab")
  public static final Block block = null;
  
  @ObjectHolder("gct_all:evileye_slab_double")
  public static final Block block_slab_double = null;
  
  public BlockEvileyeSlab(GctAllContent instance) {
    super(instance, 74);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("evileye_slab"));
    this.elements.blocks.add(() -> (Block)(new BlockCustom.Double()).setRegistryName("evileye_slab_double"));
  ...
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "evileye_slab");
  }
  
  public static class BlockCustom extends BlockSlab {
    public BlockCustom() {
      super(Material.WOOD);
      setTranslationKey("evileye_slab");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
      return Item.getItemFromBlock(BlockEvileyeSlab.block);
    }
    
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
      return new ItemStack(BlockEvileyeSlab.block);
    }
