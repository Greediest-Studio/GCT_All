...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockPolarisiteDarkSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockPolarisiteDarkSlab();
  public static final Block block_slab_double = new Double();

  public BlockPolarisiteDarkSlab() {
    super(Material.ROCK);
  ...
  public static class Double extends BlockPolarisiteDarkSlab {
    public Double() {
      super();
    }
