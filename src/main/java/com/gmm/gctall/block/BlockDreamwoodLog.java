...
@Tag
public class BlockDreamwoodLog extends GctAllElement {
  @ObjectHolder("gct_all:dreamwood_log")
  public static final Block block = null;
  
  public BlockDreamwoodLog(GctAllContent instance) {
    super(instance, 228);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("dreamwood_log"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "dreamwood_log");
  }
  ...
  public static class BlockCustom extends Block {
    ...
    public BlockCustom() {
      super(Material.ROCK);
      setTranslationKey("dreamwood_log");
