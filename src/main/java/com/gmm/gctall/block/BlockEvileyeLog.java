...
@Tag
public class BlockEvileyeLog extends GctAllElement {
  @ObjectHolder("gct_all:evileye_log")
  public static final Block block = null;
  
  public BlockEvileyeLog(GctAllContent instance) {
    super(instance, 71);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("evileye_log"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "evileye_log");
  }
