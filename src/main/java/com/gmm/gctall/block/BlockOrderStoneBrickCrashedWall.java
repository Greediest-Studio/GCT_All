...
public class BlockOrderStoneBrickCrashedWall extends BlockWall {
    public static final Block block = new BlockOrderStoneBrickCrashedWall();

    public BlockOrderStoneBrickCrashedWall() {
