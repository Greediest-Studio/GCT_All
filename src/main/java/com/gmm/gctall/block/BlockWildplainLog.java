...
@Tag
public class BlockWildplainLog extends GctAllElement {
  @ObjectHolder("gct_all:wildplain_log")
  public static final Block block = null;
  
  public BlockWildplainLog(GctAllContent instance) {
    super(instance, 207);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("wildplain_log"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "wildplain_log");
  }
