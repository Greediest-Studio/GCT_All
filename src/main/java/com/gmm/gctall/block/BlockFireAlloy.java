...
public class BlockFireAlloy extends BlockFluidClassic {
    ...
    private static Fluid registerFluid() {
        Fluid fluid = new Fluid("fire_alloy",
                new ResourceLocation("gct_all:blocks/fire_alloy_still"),
                new ResourceLocation("gct_all:blocks/fire_alloy_flow"))
                .setLuminosity(0)
                .setDensity(1000)
                .setViscosity(4000)
                .setGaseous(false);
    ...
    public static void registerModels(ModelRegistryEvent event) {
        GctAllFluidModels.register(block, item, "fire_alloy");
    }
}
