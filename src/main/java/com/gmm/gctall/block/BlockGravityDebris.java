...
@Tag
public class BlockGravityDebris extends GctAllElement {
  @ObjectHolder("gct_all:gravity_debris")
  public static final Block block = null;
  
  public BlockGravityDebris(GctAllContent instance) {
    super(instance, 375);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("gravity_debris"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "gravity_debris");
  }
