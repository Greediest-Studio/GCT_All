...
@Tag
public class BlockElementiumOre extends GctAllElement {
  @ObjectHolder("gct_all:elementium_ore")
  public static final Block block = null;
  
  public BlockElementiumOre(GctAllContent instance) {
    super(instance, 244);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("elementium_ore"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "elementium_ore");
  }
