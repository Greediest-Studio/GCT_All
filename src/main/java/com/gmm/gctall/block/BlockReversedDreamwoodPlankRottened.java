...
@Tag
public class BlockReversedDreamwoodPlankRottened extends GctAllElement {
  @ObjectHolder("gct_all:reversed_dreamwood_plank_rottened")
  public static final Block block = null;
  
  public BlockReversedDreamwoodPlankRottened(GctAllContent instance) {
    super(instance, 278);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("reversed_dreamwood_plank_rottened"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "reversed_dreamwood_plank_rottened");
  }
  ...
  public static class BlockCustom extends Block {
    ...
    public BlockCustom() {
      super(Material.ROCK);
      setTranslationKey("reversed_dreamwood_plank_rottened");
