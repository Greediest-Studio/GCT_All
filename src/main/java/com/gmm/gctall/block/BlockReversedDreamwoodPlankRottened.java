...
import net.minecraft.world.World;
  ...
  public class BlockReversedDreamwoodPlankRottened extends Block {
  public static final PropertyDirection FACING = BlockDirectional.FACING;
  public static final Block block = new BlockReversedDreamwoodPlankRottened();

  public BlockReversedDreamwoodPlankRottened() {
    super(Material.ROCK);
