...
@Tag
public class BlockWildplainSlab extends GctAllElement {
  @ObjectHolder("gct_all:wildplain_slab")
  public static final Block block = null;
  
  @ObjectHolder("gct_all:wildplain_slab_double")
  public static final Block block_slab_double = null;
  
  public BlockWildplainSlab(GctAllContent instance) {
    super(instance, 210);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("wildplain_slab"));
    this.elements.blocks.add(() -> (Block)(new BlockCustom.Double()).setRegistryName("wildplain_slab_double"));
  ...
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "wildplain_slab");
  }
  
  public static class BlockCustom extends BlockSlab {
    public BlockCustom() {
      super(Material.WOOD);
      setTranslationKey("wildplain_slab");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
      return Item.getItemFromBlock(BlockWildplainSlab.block);
    }
    
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
      return new ItemStack(BlockWildplainSlab.block);
    }
