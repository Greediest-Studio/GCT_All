...
public class BlockRainboquartzSlab extends BlockSlab {
    public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
    public static final Block block = new BlockRainboquartzSlab();
    public static final Block block_slab_double = new Double();

    public BlockRainboquartzSlab() {
    super(Material.ROCK);
    ...
    public static class Double extends BlockRainboquartzSlab
    {
    public Double() {
    super();
    }
