...
@Tag
public class BlockSolokSlab extends GctAllElement {
  @ObjectHolder("gct_all:solok_slab")
  public static final Block block = null;
  
  @ObjectHolder("gct_all:solok_slab_double")
  public static final Block block_slab_double = null;
  
  public BlockSolokSlab(GctAllContent instance) {
    super(instance, 205);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("solok_slab"));
    this.elements.blocks.add(() -> (Block)(new BlockCustom.Double()).setRegistryName("solok_slab_double"));
  ...
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "solok_slab");
  }
  
  public static class BlockCustom extends BlockSlab {
    public BlockCustom() {
      super(Material.WOOD);
      setTranslationKey("solok_slab");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
      return Item.getItemFromBlock(BlockSolokSlab.block);
    }
    
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
      return new ItemStack(BlockSolokSlab.block);
    }
