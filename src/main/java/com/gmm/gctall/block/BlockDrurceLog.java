...
@Tag
public class BlockDrurceLog extends GctAllElement {
  @ObjectHolder("gct_all:drurce_log")
  public static final Block block = null;
  
  public BlockDrurceLog(GctAllContent instance) {
    super(instance, 213);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("drurce_log"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "drurce_log");
  }
