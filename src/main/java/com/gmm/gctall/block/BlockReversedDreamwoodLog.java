...
@Tag
public class BlockReversedDreamwoodLog extends GctAllElement {
  @ObjectHolder("gct_all:reversed_dreamwood_log")
  public static final Block block = null;
  
  public BlockReversedDreamwoodLog(GctAllContent instance) {
    super(instance, 276);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("reversed_dreamwood_log"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "reversed_dreamwood_log");
  }
  ...
  public static class BlockCustom extends Block {
    ...
    public BlockCustom() {
      super(Material.ROCK);
      setTranslationKey("reversed_dreamwood_log");
