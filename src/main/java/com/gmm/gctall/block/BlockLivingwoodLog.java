...
@Tag
public class BlockLivingwoodLog extends GctAllElement {
  @ObjectHolder("gct_all:livingwood_log")
  public static final Block block = null;
  
  public BlockLivingwoodLog(GctAllContent instance) {
    super(instance, 70);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("livingwood_log"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "livingwood_log");
  }
  ...
  public static class BlockCustom extends Block {
    ...
    public BlockCustom() {
      super(Material.ROCK);
      setTranslationKey("livingwood_log");
