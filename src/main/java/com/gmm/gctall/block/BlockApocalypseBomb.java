...
@Tag
public class BlockApocalypseBomb extends GctAllElement {
  @ObjectHolder("gct_all:apocalypse_bomb")
  public static final Block block = null;
  
  public BlockApocalypseBomb(GctAllContent instance) {
    super(instance, 23);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("apocalypse_bomb"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "apocalypse_bomb");
  }
