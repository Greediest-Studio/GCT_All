...
@Tag
public class BlockCrystalsandstoneSlab extends GctAllElement {
  @ObjectHolder("gct_all:crystalsandstone_slab")
  public static final Block block = null;
  
  @ObjectHolder("gct_all:crystalsandstone_slab_double")
  public static final Block block_slab_double = null;
  
  public BlockCrystalsandstoneSlab(GctAllContent instance) {
    super(instance, 322);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("crystalsandstone_slab"));
    this.elements.blocks.add(() -> (Block)(new BlockCustom.Double()).setRegistryName("crystalsandstone_slab_double"));
  ...
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "crystalsandstone_slab");
  }
  ...
  public static class BlockCustom extends BlockSlab {
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
      return Item.getItemFromBlock(BlockCrystalsandstoneSlab.block);
    }
    
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
      return new ItemStack(BlockCrystalsandstoneSlab.block);
    }
