...
@Tag
public class BlockEthauxiumOre extends GctAllElement {
  @ObjectHolder("gct_all:ethauxiumore")
  public static final Block block = null;
  
  public BlockEthauxiumOre(GctAllContent instance) {
    super(instance, 12);
  }
  
  public void initElements() {
    registerBlockWithItem(BlockCustom::new, "ethauxiumore");
  }
