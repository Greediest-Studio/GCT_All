...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockDreadiumOre extends Block {
  public static final Block block = new BlockDreadiumOre();public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
