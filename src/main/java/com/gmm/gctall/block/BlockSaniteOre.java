...
@Tag
public class BlockSaniteOre extends GctAllElement {
  @ObjectHolder("gct_all:saniteore")
  public static final Block block = null;
  
  public BlockSaniteOre(GctAllContent instance) {
    super(instance, 4);
  }
  
  public void initElements() {
    registerBlockWithItem(BlockCustom::new, "saniteore");
  }
