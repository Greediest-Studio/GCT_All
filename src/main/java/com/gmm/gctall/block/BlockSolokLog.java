...
@Tag
public class BlockSolokLog extends GctAllElement {
  @ObjectHolder("gct_all:solok_log")
  public static final Block block = null;
  
  public BlockSolokLog(GctAllContent instance) {
    super(instance, 201);
  }
  
  public void initElements() {
    this.elements.blocks.add(() -> (Block)(new BlockCustom()).setRegistryName("solok_log"));
    this.elements.items.add(() -> RegistrationHelper.itemBlock(block));
  }
  
  @SideOnly(Side.CLIENT)
  public void registerModels(ModelRegistryEvent event) {
    RegistrationHelper.registerBlockItemModel(block, "solok_log");
  }
