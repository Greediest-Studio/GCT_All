...
import net.minecraftforge.fml.relauncher.SideOnly;
  ...
  public class BlockPolarisiteSlab extends BlockSlab {
  public static final PropertyEnum<Variant> VARIANT = PropertyEnum.create("variant", Variant.class);
  public static final Block block = new BlockPolarisiteSlab();
  public static final Block block_slab_double = new Double();

  public BlockPolarisiteSlab() {
    super(Material.ROCK);
  ...
  public static class Double extends BlockPolarisiteSlab {
    public Double() {
      super();
    }
