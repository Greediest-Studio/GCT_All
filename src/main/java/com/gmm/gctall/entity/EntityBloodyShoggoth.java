...
public final class EntityBloodyShoggoth {
  ...
  public static final int ENTITYID_RANGED = 16;  public static void registerEntities(net.minecraftforge.event.RegistryEvent.Register<EntityEntry> event) {
    event.getRegistry().register(EntityEntryBuilder.create().entity(BloodyShoggothEntity.class).id(new ResourceLocation("gct_all", "bloody_shoggoth"), 15).name("bloody_shoggoth").tracker(64, 3, true).egg(-16777216, -16711681).build());
  }
  ...
  public static void registerRenderers(FMLPreInitializationEvent event) {
    RenderingRegistry.registerEntityRenderingHandler(BloodyShoggothEntity.class, renderManager -> new RenderLiving(renderManager, new ModelShoggoth(), 1.0F) {
          protected ResourceLocation getEntityTexture(Entity entity) {
            return new ResourceLocation("gct_all:textures/shoggoth_bloody.png");
          }
        });
  }

  public static class BloodyShoggothEntity extends EntityMob {
    public BloodyShoggothEntity(World world) {
      super(world);
      setSize(2.5F, 2.5F);
