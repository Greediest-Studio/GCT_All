...
@Tag
public class EntityBloodyShoggoth extends GctAllElement {
  public static final int ENTITYID = 15;
  
  public static final int ENTITYID_RANGED = 16;
  
  public EntityBloodyShoggoth(GctAllContent instance) {
    super(instance, 119);
  }
  
  public void initElements() {
    registerEntity(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("gct_all", "bloody_shoggoth"), 15).name("bloody_shoggoth").tracker(64, 3, true).egg(-16777216, -16711681).build());
  }
