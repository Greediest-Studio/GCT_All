...
public class ItemAlfheim extends Item {
  public static final Item block = new ItemAlfheim().setTranslationKey("alfheim").setRegistryName("alfheim");
  ...
  public EnumActionResult onItemUse(EntityPlayer entity, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
    ...
    if (world.isAirBlock(pos))
      WorldAlfheim.portal.portalSpawn(world, pos);
